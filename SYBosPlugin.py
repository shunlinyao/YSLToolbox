...
class CSYBosPlugin():
    ...
    def __init__(self, config, end_point):
        self.bos_client = self.init_bj_bosclient(config, end_point)
    ...
    def init_bj_bosclient(self, config, end_point):
